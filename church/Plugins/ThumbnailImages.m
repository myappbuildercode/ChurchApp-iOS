...
//    [self.viewController presentViewController:thumbnailImageCol animated:YES completion:nil];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self
                                             selector:@selector(passValueTOphoneGap:)
                                               ...
                                               object:nil];
    thumbnailImageCol = [storyboard instantiateViewControllerWithIdentifier:@"galleryView"];_navigationController = [[UINavigationController alloc] initWithRootViewController:thumbnailImageCol];
