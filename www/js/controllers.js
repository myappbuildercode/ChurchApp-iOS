					...
					cordova.exec(function(response){
						...
						$scope.beforevideoupload=false;
						 ...
						 if(videoframe != 'null'){
					    	...
					    	var alertPopup = $ionicPopup.alert({
     						title: 'Church App',
     						template: ' Video file selected successfully'
   									});
   							alertPopup.then(function(res) {
...
//                    }    
  ...
  }, "Thumbnail", "thumbnail",[localStorage.appkey,$rootScope.mainbuttonid,$scope.videowithdescriptioncreatevalues.title,$scope.videowithdescriptioncreatevalues.text,"Nothumbnail","post"])
...
control.controller('videowithdescriptionpageCtrl', function($scope, $state, $rootScope, $ionicPopover, $ionicSideMenuDelegate, $sce, $ionicLoading, $http, $location, $ionicModal, $ionicPopup, $ionicActionSheet, $ionicSlideBoxDelegate) {
           ...
           $scope.videoclick=function(videobuttonarray){
					...
					cordova.exec(null, null, "Echo", "echo", [videobuttonarray.elements[0].video.url,"YES"]);
...
//                    } 
  	 ...
  	 $ionicLoading.hide();
                           ...
                           }, "Thumbnail", "thumbnail",[localStorage.appkey,$rootScope.buttoncontent.elements[0].id,$scope.videowithdescriptioneditvalues.title,$scope.videowithdescriptioneditvalues.text,"Nothumbnail","put"])
